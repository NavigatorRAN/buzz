...
const OUTPUT_SCHEMA: &str = "Return exactly one JSON object only. Every factual finding and proposed action cites one or more source ledger IDs; include limitations and dissent verbatim; every proposed action has approval_state 'pending'.";
